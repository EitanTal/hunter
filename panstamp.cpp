 ...
 */
void PANSTAMP::enableRepeater(uint8_t maxHop)
{
  if (repeater == NULL)
  {
 ...
 */
void PANSTAMP::setup_watchdog(uint8_t time) 
{
  uint8_t bb;
 ...
 */
void PANSTAMP::setup_rtc(uint8_t time)
{
 ...
 *  WDTO_8S = 8 s
 */
void PANSTAMP::sleepWd(uint8_t time) 
{
  // Power-down CC1101
 ...
 *  RTC_8S = 8 s
 */
void PANSTAMP::sleepRtc(uint8_t time) 
{
  // Power-down CC1101
  cc1101.setPowerDownState();
  // Power-down panStamp
 ...
 */
void PANSTAMP::setTxInterval(uint8_t* interval, bool save)
{
 ...
 */
void PANSTAMP::setSmartPassword(uint8_t* password)
{
  // Save password
